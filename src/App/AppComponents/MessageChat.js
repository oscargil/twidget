...
export default class MessageChat {
    ...
    buildMessageAlt(){
        ...
        if(this.platform == "youtube"){
            platformSrc = "../public/static/images/youtube.png";
        } 
        if(this.platform == "facebook"){
            platformSrc = "../public/static/images/facebook.png";
        }
        if(this.platform == "twitch"){
            platformSrc = "../public/static/images/twitch.png";
        }
        ...
        switch(this.userStatus){
            case "owner":
                ...
                break;
            case "moderator":
                chatNameContent = "<span class='moderatorName'>" + this.name + " <img src='../assets/images/mod-icon.png' /></span>";
                break;
            default:
